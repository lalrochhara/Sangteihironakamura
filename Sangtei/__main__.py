...
from Sangtei import BOT_NAME, BOT_USERNAME, HELPABLE, UBOT_NAME, app, scheduler
from Sangtei.plugins import ALL_MODULES
from Sangtei.plugins.web_scraper import web
from Sangtei.vars import SUDO, USER_SESSION
...
async def start_bot():
    for module in ALL_MODULES:
        imported_module = importlib.import_module(f"Sangtei.plugins.{module}")
