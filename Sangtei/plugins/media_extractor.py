...
from Sangtei import app
from Sangtei.core.decorator.errors import capture_err
from Sangtei.core.decorator.ratelimiter import ratelimiter
from Sangtei.core.Sangtei_patch.listen.listen import ListenerTimeout
from Sangtei.helper.human_read import get_readable_time
from Sangtei.helper.localization import use_chat_lang
from Sangtei.helper.pyro_progress import progress_for_pyrogram
from Sangtei.helper.tools import get_random_string
from Sangtei.plugins.dev import shell_exec
from Sangtei.vars import COMMAND_HANDLER
...
def get_subname(lang, url, ext):
    ...
    if scheme_removed.find("/") == -1 or not get_base_name(
        ...
        return f"[{lang.upper()}] SangteiSub{get_random_string(4)}.{ext}"
