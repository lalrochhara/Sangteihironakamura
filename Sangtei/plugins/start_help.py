...
from Sangtei import BOT_NAME, BOT_USERNAME, HELPABLE, app
from Sangtei.core.decorator.ratelimiter import ratelimiter
from Sangtei.helper import bot_sys_stats, paginate_modules
...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(
                text="Terms of Use",
                url="https://t.me/ZoYakumoUpdates/1013",
            ),
        ],
        [
            InlineKeyboardButton(
            ...
            InlineKeyboardButton(text="Creator", url="https://t.me/NickyLrca"),
        ],
        [
            InlineKeyboardButton(
...
async def start(_, ctx: Message, strings):
    if ctx.chat.type.value != "private":
        ...
        return await ctx.reply_photo(
            photo="https://i.ibb.co/mHfjVdB/Bottt.png",
...
async def help_parser(name, keyb=None):
    ...
    return (
        """Hello {first_name}, My name is {bot_name} [❤️](https://i.ibb.co/mHfjVdB/Bottt.png).
